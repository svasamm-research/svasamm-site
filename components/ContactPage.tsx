...
export default function ContactPage() {
  return (
    <section className="pp-glow" style={{ borderBottom: "1px solid var(--color-divider)" }}>
      ...
      <div className="pp-wrap pp-two" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 52, padding: "44px 24px 72px", alignItems: "start" }}>
        <div>
          <div className="tag tag-outline" style={{ marginBottom: 20 }}>Get started</div>
          <h1 style={{ fontSize: 42, lineHeight: 1.08, letterSpacing: "-.025em", margin: "0 0 16px", color: "var(--color-text)" }}>Tell us what you run. We&apos;ll show you the fit.</h1>
          <p style={{ fontSize: 16, lineHeight: 1.6, color: "var(--color-neutral-300)", margin: "0 0 30px" }}>A short walkthrough with the people who build the software — not a sales script. We&apos;ll map your workflow to a product and be honest about where it fits.</p>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, color: "var(--color-text)" }}>
              ...
              <span><span style={{ display: "block", fontSize: 12, color: "var(--color-neutral-500)" }}>Office</span>Nabagram, Konnagar, Hooghly, WB 712246</span>
            </div>
          </div>
        </div>
        <ContactForm />
