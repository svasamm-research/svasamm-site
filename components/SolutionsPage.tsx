  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="pp-wrap sv-hero-content"
          style={{ padding: "40px 24px 56px", maxWidth: 760 }}
        >
          ...
          >
            ...
            and Svasamm Digital services get your facility found online. Open
            any of them for the full detail.
          </p>
        </div>
      </section>
              ...
              >
                ...
                >
                  <span className="sv-chip">
                    <Icon name={p.icon} style={{ fontSize: 25 }} />
                  </span>
                  <div>
                    <h2
                      style={{
