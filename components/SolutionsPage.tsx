    ...
    <>
      <section className="pp-glow sv-hero" style={{ borderBottom: "1px solid var(--color-divider)" }}>
        ...
        <div className="pp-wrap sv-hero-content" style={{ padding: "40px 24px 56px", maxWidth: 760 }}>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.6, color: "var(--color-neutral-300)", margin: 0 }}>Vertical products carry an entire industry&apos;s workflow inside; platform modules are the horizontal systems every operation runs; services are delivered by our team. Open any of them for the full detail.</p>
        </div>
      </section>
