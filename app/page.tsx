      ...
      <main id="main" className="flex-1">
        ...
        >
          ...
          <div
            ...
            style={{ padding: "76px 24px 84px" }}
          >
            <div style={{ maxWidth: "56ch" }}>
              <div className="tag tag-outline" style={{ marginBottom: 22 }}>
                Svasamm Research Pvt Ltd · India
              </div>
              <h1
                style={{
                  fontSize: 52,
                  ...
                  <>
                    <div
                      style={{
                        ...
                        placeItems: "center",
                        background:
                          "radial-gradient(120% 120% at 30% 0%, var(--color-accent-100), var(--color-bg) 78%)",
          ...
          >
            <div>
              ...
              >
                ...
                to CMR obligations across the eastern belt — and deploy
                pan-India and for global teams.
              </p>
              <div
                style={{
                  display: "flex",
            ...
            >
              {WHYS.map((w) => (
                ...
                >
                  <Icon
                    name={w.icon}
                    style={{ fontSize: 28, color: "var(--color-accent-300)" }}
                  />
                  <h3
                    style={{
                      fontSize: 17,
