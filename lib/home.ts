...
export const HOME_PRODUCTS: HomeProduct[] = [
  ...
  { id: "digital-healthcare", name: "Svasamm Digital for Healthcare", kind: "service", tag: "Service", tagClass: "tag-neutral", icon: "ph-megaphone", short: "Healthcare digitisation", href: "/pages/digital-healthcare.html", external: false, blurb: "Website, Google Business Profile, local SEO and marketing for clinics, nursing homes and small hospitals — with category exclusivity in your catchment.", cta: "Explore Digital for Healthcare", ctaIcon: "ph-arrow-right" },
  { id: "digital-schools", name: "Svasamm Digital for Schools", kind: "service", tag: "Service", tagClass: "tag-neutral", icon: "ph-graduation-cap", short: "School digitisation", href: "/pages/digital-schools.html", external: false, blurb: "Website, Google Business Profile, local SEO and admissions marketing for schools, pre-schools and coaching institutes — with category exclusivity in your catchment.", cta: "Explore Digital for Schools", ctaIcon: "ph-arrow-right" },
];
