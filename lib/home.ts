...
export const HOME_PRODUCTS: HomeProduct[] = [
  ...
  { id: "digital", name: "Svasamm Digital", kind: "vertical", tag: "Service", tagClass: "tag-neutral", icon: "ph-megaphone", short: "Healthcare digitisation", href: "/pages/digital.html", external: false, blurb: "Website, Google Business Profile, local SEO and marketing for clinics, nursing homes and small hospitals — with category exclusivity in your catchment.", cta: "Explore Svasamm Digital", ctaIcon: "ph-arrow-right" },
];
